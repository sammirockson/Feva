...
class SignUpViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    lazy var backgroundImageView: UIImageView = {
        let v = UIImageView()
        v.image = #imageLiteral(resourceName: "BackgroundGradient")
...
//        v.image = #imageLiteral(resourceName: "file")
    ...
    lazy var signUpButton: UIButton = {
        ...
        button.setBackgroundImage(#imageLiteral(resourceName: "BackgroundGradient"), for: .normal)
        button.setTitle("Sign Up", for: .normal)
        button.titleLabel?.font = OptimizedFont.font(fontName: FontNames.OpenSansSemiBold, fontSize: 18)
    ...
    lazy var noteLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = OptimizedFont.font(fontName: FontNames.OpenSansRegular, fontSize: 12)
